<div class="grid grid-cols-2 h-2/3 w-3/4  grid-rows-3 my-4 mx-auto">
  ...
  <form class="col-span-1 col-start-1 col-end-2 row-start-3 self-center object-cover">
    <input type="text" class="p-5 text-smoke-700 border-2 rounded-l-xl rounded-r-none focus:ring-0 focus:outline-0  border-orange-500 w-3/4" placeholder="Back-end Developer" name="" id="">
